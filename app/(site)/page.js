  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 md:px-8">
        <div className="mb-8">
          <p className="text-xs font-semibold uppercase tracking-widest text-electric-600">Browse</p>
          <h2 className="font-display text-3xl font-bold text-navy">Shop by Category</h2>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 md:px-8">
        <div className="grid gap-10 rounded-3xl border border-navy-100 bg-white p-8 md:grid-cols-2 md:p-14">
          <div>
            <p className="text-xs font-semibold uppercase tracking-widest text-emerald">Our story</p>
            <h2 className="mt-2 font-display text-3xl font-bold text-navy">About Mecca City Boutique</h2>
          ...
          <div className="rounded-2xl bg-navy-50 p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-electric-600">Visit / Order</p>
            <p className="mt-3 font-display text-lg font-semibold text-navy">{SHOP_LOCATION}</p>
            <ul className="mt-3 space-y-1 text-sm text-navy-500">
