...
export function productWhatsAppMessage(productName, size) {
  if (size) {
    return `Hello Mecca City Boutique, I am interested in ${productName} (size ${size}). Is it available?`;
  }
  return `Hello Mecca City Boutique, I am interested in ${productName}. Is it available?`;
}
